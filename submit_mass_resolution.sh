...
INPUT_DIR3=/cache/clas12/rg-a/production/recon/spring2019/torus-1/pass2/dst/train/${TRAIN_NAME}/
OUTPUT_DIR=/work/clas12/spaul/mass_resolution/
...
srun clas12root -l -b -q /home/spaul/charm_studies/src/TuplesForMassResolution.C --in=$FILE --out=$OUTFILE --FTonly
